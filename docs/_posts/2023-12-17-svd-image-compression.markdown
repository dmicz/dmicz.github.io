...
One possible use case of SVD is as a method for compressing images, which is explained in this notebook (available on my [GitHub repo](https://github.com/dmicz/dmicz.github.io) in .ipynb format).
...
![png](/assets/img/svd_compression/svd_compression_7_0.png)
...
![png](/assets/img/svd_compression/svd_compression_31_0.png)
...
![png](/assets/img/svd_compression/svd_compression_33_0.png)
